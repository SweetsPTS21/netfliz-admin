...
public class B2Config {
    ...
    public S3Client s3Client() {
        AwsBasicCredentials creds = AwsBasicCredentials.create(b2Properties.getAccessKeyId(), b2Properties.getSecretAccessKey());

        return S3Client.builder()
                .endpointOverride(URI.create(b2Properties.getEndpoint()))
                .credentialsProvider(StaticCredentialsProvider.create(creds))
                .region(Region.of(b2Properties.getRegion()))
